...
pub const NMHD: [u8; 4] = fourcc("nmhd"); // Null Media Header Box (§8.4.5.2)
pub const STHD: [u8; 4] = fourcc("sthd"); // Subtitle Media Header Box (§12.6.2)
pub const ELNG: [u8; 4] = fourcc("elng"); // Extended Language Tag Box (§8.4.6)
